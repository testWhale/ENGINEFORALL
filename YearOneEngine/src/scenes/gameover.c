...
void GameOver_SetData(float finalTime, int goals) { GO_finalTime = finalTime; GO_goals = goals; }
...
void GameOver_Update(void) {
    ...
    CP_Settings_Fill(CP_Color_Create(0, 0, 0, (int)GO_fade)); CP_Graphics_DrawRect(0, 0, W, H);
    CP_Settings_Fill(CP_Color_Create(235, 235, 235, 255)); CP_Settings_TextSize(72.0f);
