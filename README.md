...
| Directory       | Description                                                                     |
| --------------- | ------------------------------------------------------------------------------- |
| **src/bullet**  | Handles bullet logic, projectile behavior, collisions, and damage calculations. |
| **src/buttons** | UI button components, interactions, and events.                                 |
| **src/clicker** | Core clicker-style gameplay logic (increment systems, click events, scaling).   |
| **src/economy** | Currency systems, upgrades, resource generation, and balancing logic.           |
| **src/entity**  | Base entity classes, movement, rendering, and shared game object logic.         |
